...
class PersistHelper {
  ...
  Future<bool> setHeartRate(String value) async {
    return await sharedPreferences.setString(Preferences.heartRateValue, value);
  }

  Future<String?> getHeartRate() async {
    return sharedPreferences.getString(Preferences.heartRateValue);
  }
