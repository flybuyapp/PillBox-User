...
import 'package:flybuy/widgets/sleep_widgets/uniform_box_decoration.dart';
...
class WakeupList extends StatelessWidget {
  ...
  /*
    Constructor.
   */
  WakeupList(int sleepDuration, averageDuration, goToBedTime,
      averageGoToBedTime, wakeupTime, averageWakeupTime)
      : _labelTexts = ["Duration", "Went to bed", "Woke up"],
        ...
        _currentTimes = [sleepDuration, goToBedTime, wakeupTime],
        _averageTimes = [
          averageDuration,
          averageGoToBedTime,
          averageWakeupTime
          ...
          itemBuilder: (context, index) {
            return Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  customAnimatedChart(index, _currentTimes[index],
                      _averageTimes[index], _labelTexts[index]),
                  Container(
                    child: Column(
                      children: <Widget>[
                        Container(
