...
class _CheckoutState extends State<Checkout>
  ...
  Future<void> _progressCheckout(BuildContext context) async {
    print('INIT ::: ${_cartStore.paymentStore.gateways[_cartStore.paymentStore.active].title} ::::: ${methods[_cartStore.paymentStore.method]}');
    print("stripePayment ::: ${_cartStore
  ...
  List<Gateway> _getGateways() {
    ...
    if (!_authStore.isLogin) {
      print('_getGateways :: ${_cartStore.paymentStore.gateways[0].settings}');
