...
class _ProductScreenState extends State<ProductScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Observer(builder: (_) {
      ...
      int? initMax = b2bkingFilterQuantity(context, _product?.stockQuantity != null && _product!.stockQuantity! > 0 ? _product?.stockQuantity : CirillaQuantity.maxQty, _product ?? Product(), "max");
